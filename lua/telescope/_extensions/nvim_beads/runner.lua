...
local read = require("nvim_beads._commands.goodnight_moon.read")
local say_runner = require("nvim_beads._commands.hello_world.say.runner")
local tabler = require("nvim_beads._core.tabler")

---@diagnostic disable-next-line: deprecated
local unpack = unpack or table.unpack

vim.api.nvim_set_hl(0, "YourPluginTelescopeEntry", { link = "TelescopeResultsNormal", default = true })
vim.api.nvim_set_hl(0, "YourPluginTelescopeSecondary", { link = "TelescopeResultsComment", default = true })
            ...
            entry_maker = function(data)
                ...
                return {
                    display = function(entry)
                        return displayer({
                            { entry.name, "YourPluginTelescopeEntry" },
                            { entry.author, "YourPluginTelescopeSecondary" },
                        })
                    end,
                    author = author,
                    name = name,
