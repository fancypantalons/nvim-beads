...
download-dependencies:
	...
	git clone git@github.com:YourUsername/mega.cmdparse.git .dependencies/mega.cmdparse $(IGNORE_EXISTING)
	git clone git@github.com:YourUsername/mega.logging.git .dependencies/mega.logging $(IGNORE_EXISTING)
