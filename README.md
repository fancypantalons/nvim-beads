...
⚠️ Alpha Status: Both this and the beads project in general are in active development and the API and interface could change substantially before version 1.0. Use for development/internal projects first.

| <!-- --> | <!-- --> |
|--------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Build Status | [![unittests](https://img.shields.io/github/actions/workflow/status/fancypantalons/nvim-beads/test.yml?branch=main&style=for-the-badge&label=Unittests)](https://github.com/fancypantalons/nvim-beads/actions/workflows/test.yml) [![luacheck](https://img.shields.io/github/actions/workflow/status/fancypantalons/nvim-beads/luacheck.yml?branch=main&style=for-the-badge&label=Luacheck)](https://github.com/fancypantalons/nvim-beads/actions/workflows/luacheck.yml) [![luacov](https://img.shields.io/github/actions/workflow/status/fancypantalons/nvim-beads/luacov.yml?branch=main&style=for-the-badge&label=Coverage)](https://github.com/fancypantalons/nvim-beads/actions/workflows/luacov.yml) [![checkhealth](https://img.shields.io/github/actions/workflow/status/fancypantalons/nvim-beads/checkhealth.yml?branch=main&style=for-the-badge&label=checkhealth)](https://github.com/fancypantalons/nvim-beads/actions/workflows/checkhealth.yml) [![stylua](https://img.shields.io/github/actions/workflow/status/fancypantalons/nvim-beads/stylua.yml?branch=main&style=for-the-badge&label=Stylua)](https://github.com/fancypantalons/nvim-beads/actions/workflows/stylua.yml) [![mdformat](https://img.shields.io/github/actions/workflow/status/fancypantalons/nvim-beads/mdformat.yml?branch=main&style=for-the-badge&label=mdformat)](https://github.com/fancypantalons/nvim-beads/actions/workflows/mdformat.yml) |
| License | [![License-MIT](https://img.shields.io/badge/License-MIT-blue?style=for-the-badge)](https://github.com/fancypantalons/nvim-beads/blob/main/LICENSE) |
